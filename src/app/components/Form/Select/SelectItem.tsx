...
export function SelectItem({ text, ...rest }: SelectItemProps) {
  return (
    <Select.Item
      className="flex items-center justify-between gap-2 px-3 py-2.5 outline-none data-[highlighted]:cursor-pointer data-[highlighted]:bg-violet-50 dark:data-[highlighted]:bg-zinc-700"
      {...rest}
    >
